var data = {
  ...
  projects: [{
    ...
    date: "",
    description: "",
    main_image_url: "img/projects/project1.jpg",
    images: []
  }, {
    name: "Project 2",
    date: "",
    description: "",
    main_image_url: "img/projects/project2.jpg",
    images: []
  }, {
    name: "Project 3",
    date: "",
    description: "",
    main_image_url: "img/projects/project3.jpg",
    images: []
  }, {
    name: "Project 4",
    date: "",
    description: "",
    main_image_url: "img/projects/project4.jpg",
    images: []
  }, {
    name: "Project 5",
    date: "",
    description: "",
    main_image_url: "img/projects/project5.jpg",
    images: []
  }],
  customers: {
    message: "We place customers at the heart of everything we do. Customer satisfaction is a key driver for our business.",
    list: [{
      name: "Eksper ltd.",
  ...
  partners: {
    message: "To contribute to positive change and achieve our sustainability goals, we partner with many extraordinary people around the world.",
    list: [{
      name: "Bahçeşehir Üniversitesi",
  ...
  team: {
    message: "We are constantly pushing to create the new, to overcome hurdles and to deliver exciting fresh means of expressions for our clients.",
    list: [{
